...
if uploaded_file:
    ...
    # Clean column names for matching (lowercase and stripped)
    ...
    if desc_col and cons_col and prop_col:
        ...
        st.error("Error: Could not find all required columns.")
        st.write("Found Columns:", list(df.columns))
        st.write("Looking for: 'Property Description', 'Property', and 'Consideration Value'")
